...
@Component({
  selector: 'app-approved-medical-requests',
  templateUrl: './approved-medical-requests.component.html',
  styleUrls: ['./approved-medical-requests.component.css']
})
export class ApprovedMedicalRequestsComponent {
...
//   }
  ...
  fetchAndDisplayReceiptPDF(medical: MedicalRequests):void { 
    // Call your service method to fetch the PDF file  
    console.log(medical.medicalRequestId)
    const medicalRequestToEdit = this.medicalRequests.find(medicalRequest => medicalRequest.medicalRequestId === medical.medicalRequestId); 
    console.log(medical.medicalRequestId)
    ...
    this.medicalRequestservice.getMedicalRequestReceiptFile(medicalRequestToEdit.medicalRequestId) 
...
(medicalRequest: MedicalRequests){
 ...
 console.log(medicalRequest)
  ...
  .updateMedicalRequest(medicalRequest,medicalRequestId)
  .subscribe(() =>{
    this.medicalRejected = true;
console.log("updated")
      setTimeout(() => {
        this.medicalRejected= false;
      }, 2000);
